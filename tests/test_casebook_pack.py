"""Regression checks for the kotlinsync casebook."""
...
from casebook.harness import assert_expected, kotlinsync_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(kotlinsync_summary(), assert_expected())
