...
kotlinsync is a Kotlin project for automation. It focuses on this technical goal: Plan safe file sync operations with content hashes and dry-run output.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 177, risk penalty 4, latency penalty 3, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
