...
`kotlinsync` is centered on automation work in Kotlin. The technical target is: Plan safe file sync operations with content hashes and dry-run output.
...
The score is deterministic. The current threshold is 177. Risk has a penalty of 4, latency has a penalty of 3, and weight contributes a bonus of 6.
